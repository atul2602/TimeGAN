...
from utils2 import extract_time, rnn_cell, random_generator, batch_generator
...
def timegan (ori_data, parameters):
  ...
  def embedder (X, T):
    ...
    with tf.compat.v1.variable_scope("embedder", reuse = tf.compat.v1.AUTO_REUSE):
      print("\n X_training ki shape hai:", tf.shape(X))
      print("\n T_training ki shape hai:", tf.shape(T))
      ...
      print("EHidden dimension is: ", H.shape)    
    return H
